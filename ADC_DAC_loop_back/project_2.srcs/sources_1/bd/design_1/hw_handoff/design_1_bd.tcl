...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.DIFF_CLK_IN_BOARD_INTERFACE {default_sysclk1_300mhz} \
 ] $util_ds_buf_0
  ...
  connect_bd_intf_net -intf_net Conn [get_bd_intf_pins dds_compiler_0/M_AXIS_DATA] [get_bd_intf_pins usp_rf_data_converter_0/s13_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets Conn] [get_bd_intf_pins dds_compiler_0/M_AXIS_DATA] [get_bd_intf_pins system_ila_1/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net usp_rf_data_converter_0_m00_axis [get_bd_intf_pins system_ila_1/SLOT_1_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/m00_axis]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn] [get_bd_pins vio_0/probe_in2]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac1 [get_bd_pins dds_compiler_0/aclk] [get_bd_pins system_ila_1/clk] [get_bd_pins usp_rf_data_converter_0/clk_dac1] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s1_axis_aclk] [get_bd_pins vio_0/probe_in1]
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_pins util_ds_buf_0/IBUF_OUT] [get_bd_pins util_ds_buf_1/BUFGCE_I]
  connect_bd_net -net util_ds_buf_1_BUFGCE_O [get_bd_pins util_ds_buf_1/BUFGCE_O] [get_bd_pins vio_0/clk]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins util_ds_buf_1/BUFGCE_CLR] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins util_ds_buf_1/BUFGCE_CE] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins vio_0/probe_in0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]

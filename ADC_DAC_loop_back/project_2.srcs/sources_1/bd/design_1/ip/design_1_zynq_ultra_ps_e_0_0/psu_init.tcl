...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0x50040000
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0x00B02000
    ...
    mask_write 0XFF18020C 0x00000FFF 0x00000FC0
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x03F7EF1E
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x03FBFFFF
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01FFF035
    ...
    mask_write 0XFF180178 0x03FFFFFF 0x00FC0000
    ...
    mask_write 0XFF180184 0x03FFFFFF 0x0003F000
		# : LOOPBACK
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFD1A0100 0x00018046 0x00000000
		# : RESET BLOCKS
		# : TIMESTAMP
		# Register : RST_LPD_IOU2 @ 0XFF5E0238</p>
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD402860 0x00000084 0x00000004
    ...
    mask_write 0XFD402864 0x00000084 0x00000004

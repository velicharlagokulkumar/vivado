...
create_clock -name dac0_clk_0_clk_p -period 10 [get_ports dac0_clk_0_clk_p]
create_clock -name pl_sysref_0_clk_p -period 10 [get_ports pl_sysref_0_clk_p]
create_clock -name CLK_IN_D_0_clk_p -period 2.604 [get_ports CLK_IN_D_0_clk_p]

...
// Following DDR region carved out in linkerscript so that it is available
// for passing constants from xsct to app
#define CONSTANTS_BASE 0x70000000
...
extern volatile u32* constArray;
